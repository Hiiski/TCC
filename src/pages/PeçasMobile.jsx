        ...
        <main className='font-alata text-dark-blue bg-sand h-screen'>
            ...
            <header className='flex justify-between items-center h-40 mx-12 max-lg:hidden'>
                <div className='flex'>
                    ...
                    <h2 className='font-super-ocean text-5xl ml-4 gap-4 flex self-center'>Peças Utilizadas</h2>
                </div>
                ...
                <div className='flex justify-around max-xl:text-xl list-none w-4/6 xl:text-3xl'>
                    ...
                    <li className='underline underline-offset-8 uppercase underline hover:underline decoration-dark-red'><Link to='/Peças'>Peças</Link></li>
            ...
            <section className='flex items-center justify-around max-lg:h-2/4 lg:h-4/6'>
                ...
                <section className='max-lg:hidden  mr-10 ml-10 bg-gradient-to-t from-very-dark-blue to-light-blue rounded-2xl flex items-center mt-6'>
                    <div className='  my-2 mt-0.5'>
                        <h2 className='uppercase text-white text-xl ml-4 mt-2'>Bomba Peristaltica</h2>
                        <img className='size-64 flex itens-center ml-1 h-40 my-9' src={bomb} alt="" />
                        <p className='uppercase text-white ml-4 mb-2'>R$49,90</p>
                    </div>
                </section>

                <section className='mr-10 ml-10 bg-gradient-to-t from-very-dark-blue to-light-blue rounded-2xl flex  mt-6'>
                    <div className='my-2 mt-0.5'>
                        <h2 className='uppercase text-white text-xl ml-4 mt-2'>Placa Arduino </h2>
                        <img className='size-64 flex  ml-1 h-40 my-9' src={arduino} alt="" />
                        <p className='uppercase text-white ml-4 mb-2'>R$49,90</p>
                    </div>
                </section>
